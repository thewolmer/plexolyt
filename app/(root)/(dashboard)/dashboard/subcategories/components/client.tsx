...
export const SubCategoryClient = ({
  ...
  formattedSubCategories: SubCategoryColumn[] | undefined;
}) => {
  const pathname = usePathname();

  return (
    <>
      <Header title={`SubCategories (${formattedSubCategories?.length})`} description={'Manage your store subcategory'}>
      ...
      <section className="mx-auto max-w-6xl p-10 md:py-10">
        <DataTable searchKey="name" columns={columns} data={formattedSubCategories as SubCategoryColumn[]} />
      </section>
    </>
  );
};
